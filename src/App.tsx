...
function MainAppContent() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-[#004B73] flex flex-col items-center justify-center text-white font-sans">
        ...
        <div className="text-xs text-[#D0E2EC] font-mono">Verifying Investigator Access & Session Status...</div>
      </div>
    );
  }
